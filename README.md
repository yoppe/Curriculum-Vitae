...
起業志向が強く、ここ数年は自身の起業のために開発スキルを磨いてきました。そのため１から１０まで自分でできるように手広く技術修得を進めており、バックエンドからフロントエンド、インフラ周りまで、幅広い領域をカバーしています。

また、今まで関わったプロジェクトは新規立ち上げプロジェクトが多かったため、初期の技術選定などから関われるプロジェクトだとより力を発揮できるかと思います。

エンジニアとしては、ただ言われたものを開発する作業者としてではなく、ビジネス的にも深く関わってエンジニアリングの観点から提案できるエンジニアを目指しています。

また、以前の職場でドメイン駆動設計とスクラムを開発に取り入れていたため、組織パターンがプロダクト開発に与える影響を肌で感じております。そのため、いいプロダクトを作るために開発スタイルや組織編成の改善提案をさせていただくこともあります。

そういった働き方をしているため、スポットのリモート案件よりは、現場の人と密にコミュニケーションを取ることができるフルコミットの常駐案件を得意としています。
